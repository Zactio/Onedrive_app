...
def download_function(searched_name):
    ...
    if request.method == 'POST':
        ...
        download_link = profile_photo(route=route,client=MSGRAPH, user_id='me', save_as= "Placeholder")
...
def profile_photo(*, route, client=MSGRAPH, user_id='me', save_as=None):
    ...
    # downloadUrl_responses = download_response.raw_data
    downloadUrl_response = download_response.data
    return downloadUrl_response['@microsoft.graph.downloadUrl']
    
    # return (downloadUrl_response['@odata.context'])
    # filename = save_as + '.' + 'txt'
    # print(filename)
    # print("raw data", downloadUrl_response)
    # print("raw data", downloadUrl_responses)    
...
#     debug_endpoint('/me/drive', client)
#     debug_endpoint('/me/drives', client)
#     debug_endpoint('/me/drive/root', client)
#     debug_endpoint('/me/drives', client)
#     endpoint = '/me/drive/items/'+str(item_ids) if user_id == 'me' else f'users/{user_id}/$value'
#     print ("endpoint------------------->", endpoint)
#     item_response = client.get(endpoint)
#     print(item_response._resp)
...
def debug_endpoint(endpoint, client):
    print ("endpoint------------------->", endpoint)
    item_response = client.get(endpoint)
    print("response", item_response._resp)
    item = item_response.raw_data
    print("content", item)
