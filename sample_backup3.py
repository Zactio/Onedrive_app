...
def makeNextFormString(initialFormString, LatestVersion):
    ...
    return "F"+ getPartsOfFile(initialFormString)[0][1:]+getPartsOfFile(initialFormString)[1]+LatestVersion+getPartsOfFile(initialFormString)[3]+"."+getPartsOfFile(initialFormString)[4]
